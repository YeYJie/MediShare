...
func (t *SimpleAsset) getTxTimestamp(stub shim.ChaincodeStubInterface) string {
	...
	txTimestamp := time.Unix(seconds, 0).Format("2006-01-02 15:04:05")
	return txTimestamp
}

// return txTimestamp in human-readable format
func (t *SimpleAsset) getTxTimestampString(stub shim.ChaincodeStubInterface) string {

	return t.getTxTimestamp(stub)
}

// return txTimestamp in seconds format
